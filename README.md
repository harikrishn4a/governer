...
<!-- Replace VIDEO_URL with your uploaded demo link (YouTube/Loom), and optionally
     drop a thumbnail image at docs/demo-thumbnail.png for a clickable preview. -->

📺 **[Watch the demo walkthrough →](VIDEO_URL)**

<!--
[![AgentBid demo](docs/demo-thumbnail.png)](VIDEO_URL)
-->
