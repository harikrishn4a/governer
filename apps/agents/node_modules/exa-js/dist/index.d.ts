...
type AgentRunTyped<T> = Omit<AgentRun, "output"> & {
    output?: (Omit<AgentOutput, "structured"> & {
        structured?: T;
    }) | null;
};
interface ListAgentRunsParams extends AgentBetaOptions {
    cursor?: string;
    limit?: number;
}
...
interface ListAgentRunEventsParams extends AgentBetaOptions {
    cursor?: string;
    limit?: number;
}
...
declare class AgentBaseClient {
    ...
    protected request<T = unknown>(endpoint: string, betas: string[], method?: string, data?: RequestBody$2, params?: QueryParams$3, headers?: Record<string, string>): Promise<T>;
    protected rawRequest(endpoint: string, betas: string[], method?: string, data?: RequestBody$2, params?: QueryParams$3, headers?: Record<string, string>): Promise<Response>;
...
declare class AgentRunsClient extends AgentBaseClient {
     ...
     */
    pollUntilFinished(runId: string, options: AgentBetaOptions & {
        pollInterval?: number;
        timeoutMs?: number;
    }): Promise<AgentRun & {
